const chatFullList = [
    ...
    },
    {
        ...
        content: [
            ...
            {
                me: "请多指教请多指教请多指教请多指教请多指教请多指教请多指教请多指教"
            },
        ]
    },
    {
...
const ChatList = {
    ...
    template: `
        <ul class="page-list">
            <li class="page-item" v-for="item of list" @click="getIn(item)" v-clickdown>
